...
--== Show PrawkoB                                   ==
--===============================================
RegisterNUICallback('toggleprawko_b', function(data)
	TriggerServerEvent('menu:prawko_b', myIdentifiers, data)
end)
...
--== Show PrawkoA                                   ==
--===============================================
RegisterNUICallback('toggleprawko_a', function(data)
	TriggerServerEvent('menu:prawko_a', myIdentifiers, data)
end)
...
--== Show PrawkoC                                   ==
--===============================================
RegisterNUICallback('toggleprawko_c', function(data)
	TriggerServerEvent('menu:prawko_c', myIdentifiers, data)
end)

--===============================================
--== Show Bron                                   ==
--===============================================
RegisterNUICallback('togglebron', function(data)
	TriggerServerEvent('menu:bron', myIdentifiers, data)
end)
...
AddEventHandler('sendProximityMessageID', function(id, message)
  ...
  if pid == myId then
    TriggerEvent('chatMessage', "^3Dane osobowe" .. "", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "^3Dane osobowe" .. "", {0, 153, 204}, "^7 " .. message)
  end
end)

RegisterNetEvent('sendProximityMessagePrawkoB')
AddEventHandler('sendProximityMessagePrawkoB', function(id, message)
  local myId = PlayerId()
  local pid = GetPlayerFromServerId(id)
  if pid == myId then
    TriggerEvent('chatMessage', "^3Prawo jazdy kat.B" .. "", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "^3Prawo jazdy kat.B" .. "", {0, 153, 204}, "^7 " .. message)
  end
end)

RegisterNetEvent('sendProximityMessagePrawkoA')
AddEventHandler('sendProximityMessagePrawkoA', function(id, message)
  local myId = PlayerId()
  local pid = GetPlayerFromServerId(id)
  if pid == myId then
    TriggerEvent('chatMessage', "^3Prawo jazdy kat.A" .. "", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "^3Prawo jazdy kat.A" .. "", {0, 153, 204}, "^7 " .. message)
  end
end)

RegisterNetEvent('sendProximityMessagePrawkoC')
AddEventHandler('sendProximityMessagePrawkoC', function(id, message)
  local myId = PlayerId()
  local pid = GetPlayerFromServerId(id)
  if pid == myId then
    TriggerEvent('chatMessage', "^3Prawo jazdy kat.C+D+E" .. "", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "^3Prawo jazdy kat.C+D+E" .. "", {0, 153, 204}, "^7 " .. message)
  end
end)

RegisterNetEvent('sendProximityMessageBron')
AddEventHandler('sendProximityMessageBron', function(id, message)
  local myId = PlayerId()
  local pid = GetPlayerFromServerId(id)
  if pid == myId then
    TriggerEvent('chatMessage', "^3Pozwolenie na broń" .. "", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "^3Pozwolenie na broń" .. "", {0, 153, 204}, "^7 " .. message)
  end
end)
RegisterNetEvent('sendProximityMessageLicencja')
AddEventHandler('sendProximityMessageLicencja', function(id, message)
  local myId = PlayerId()
  local pid = GetPlayerFromServerId(id)
  if pid == myId then
    TriggerEvent('chatMessage', "", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "", {0, 153, 204}, "^7 " .. message)
  end
end)
