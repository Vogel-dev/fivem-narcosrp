...
Config.Zones = {
	...
	ls1 = {
		Pos   = {x = 1114.1053466797, y = 377.54895019531, z = 6.0002574920654-1},
	...
	ls2 = {
		Pos   = {x = -1256.0234375, y = 1624.9498291016, z = 23.207921981812-1},
		Size  = {x = 3.0, y = 3.0, z = 0.8},
		Color = {r = 200, g = 100, b = 100},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = 1172.3743896484, y = 2050.8361816406, z = 16.797208786011-1},
		Size  = {x = 3.0, y = 3.0, z = 0.8},
		Color = {r = 200, g = 100, b = 100},
		Marker= 1,
		Name  = _U('blip_name'),
