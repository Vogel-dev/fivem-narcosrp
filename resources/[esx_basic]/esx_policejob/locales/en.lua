Locales['en'] = {
  ...
  ['being_searched'] = 'Jesteś ~y~przeszukiwany~s~ przez ~b~Policje~s~',
  ['being_searched2'] = 'Jesteś ~y~przeszukiwany~s~ przez ~b~Nieznajomego~s~', 
  -- Vehicle interaction
  ...
  ['jail'] = 'Wyślij do więzienia',
  ['jail_menu_info'] = 'Czas Więzienia [min]',
  -- ID Card Menu
  ['name'] = 'name: %s',
  ['job'] = 'praca: %s',
  ['sex'] = 'płeć: %s',
  ...
  ['phone_police'] = 'police',
--Kartoteka  
['criminalrecord'] = 'Kartoteka',
['add'] = 'Dodaj do kartoteki',
['crimes'] = 'Kartoteka',
['action_no'] = 'Niepoprawna opcja',
['remove'] = 'Usunąć z kartoteki?',
['yes'] = 'Tak',
['no'] = 'No',
}
