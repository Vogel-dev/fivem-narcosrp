...
local HUD = {
	...
	CarGears		= false, -- Displays vehicle gears as if the vehicle was manual transmission. (Make sure that "ParkIndicator" is set to FALSE if using this)
...
Citizen.CreateThread(function()
	while true do Citizen.Wait(1)
		...
		if(IsPedInAnyVehicle(MyPed, false))then
			...
			if HUD.Top then
				drawTxt(UI.x + 0.560, 	UI.y + 1.424, 1.0,1.0,0.55, "~w~" .. PlateVeh, 255, 255, 255, 255)
				...
				if HUD.ParkIndicator then
					if VehStopped then
						drawTxt(UI.x + 0.6605, UI.y + 1.42, 1.0,1.0,0.6, "~r~P", 255, 255, 255, 200)
					else
						drawTxt(UI.x + 0.6605, UI.y + 1.42, 1.0,1.0,0.6, "~g~D", 255, 255, 255, 200)
					end
				end
			else
				if HUD.Plate then
			...
			if HUD.CarGears then
				if VehStopped and (Speed == 0) then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "~r~P", 255, 255, 255, 200)
				elseif Gear < 1 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "R", 255, 255, 255, 200)						
				elseif Gear == 1 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "1", 255, 255, 255, 200)
				elseif Gear == 2 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "2", 255, 255, 255, 200)
				elseif Gear == 3 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "3", 255, 255, 255, 200)
				elseif Gear == 4 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "4", 255, 255, 255, 200)
				elseif Gear == 5 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "5", 255, 255, 255, 200)
				elseif Gear == 6 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "6", 255, 255, 255, 200)
				elseif Gear == 7 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "7", 255, 255, 255, 200)
				elseif Gear == 8 then
					drawTxt(UI.x + 0.660, UI.y + 1.42, 1.0,1.0,0.6, "8", 255, 255, 255, 200)
				end	
			end
			...
			if HUD.SpeedIndicator then
				...
				if HUD.Speed == 'kmh' then
					drawTxt(UI.x + 0.61, 	UI.y + 1.422, 1.0,1.0,0.64 , "~w~" .. math.ceil(Speed), 255, 255, 255, 255)
					drawTxt(UI.x + 0.633, 	UI.y + 1.428, 1.0,1.0,0.4, "~w~ km/h", 255, 255, 255, 255)
				elseif HUD.Speed == 'mph' then
					drawTxt(UI.x + 0.61, 	UI.y + 1.422, 1.0,1.0,0.64 , "~w~" .. math.ceil(Speed), 255, 255, 255, 255)
					drawTxt(UI.x + 0.633, 	UI.y + 1.428, 1.0,1.0,0.4, "~w~ mph", 255, 255, 255, 255)
				else
					drawTxt(UI.x + 0.81, 	UI.y + 1.422, 1.0,1.0,0.64 , [[Carhud ~r~ERROR~w~ ~c~in ~w~HUD Speed~c~ config (something else than ~y~'kmh'~c~ or ~y~'mph'~c~)]], 255, 255, 255, 255)
				end
			end
