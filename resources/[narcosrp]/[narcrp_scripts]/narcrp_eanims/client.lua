...
-- Commands
-- Salute: 		/e salut 		: Salute your commrads!
-- Bird 1: 		/e palec 		: One hand middle Finger
-- Bird 2: 		/e palec2 		: 2 hands middle finger
-- Surrender: 	/e poddajsie	: Kneeldown hands behind head surrender
-- Facepalm: 	/e facepalm			: Facepalm
-- Notes: 		/e notes		: Write down notes on paper
-- Brief:		/e walizka		: Equip a tactical brief case
-- Brief2:		/e walizka2		: Equip a leather brief case
-- Foldarms:	/e ochroniarz		: Cross your arms 
-- Foldarms2: 	/e ochroniarz2	: Cross arms v2
...
-- No:			/e nie			: Shake your head no
-- Pickbutt:	/e dupa		: Pick your butt
-- Grab Crotch:	/e jaja	: Grab your crotch
-- Peace:		/e kawalek		: Hold peace sign
-- Cigar:		/e cygaro		: Place cigar in your mouth
-- Cigar2:		/e cygaro2		: Place a burnt cigar in your mouth
-- Joint:		/e gibon		: Place a joint in your mouth
-- Cig:			/e papieros		: Place a cig in your mouth
-- Holdcigar:	/e cygaro3	: Hold a cigar in your hand 
-- Holdcig:		/e papieros2		: Hold a cig in your hand 
-- Holdjoint:	/e gibon2	: Hold a joint in your hand
-- Dead:		/e smierc			: Play dead
-- Holster:		/e kabura		: Hand hovers over holster 
-- Aim:			/e bron			: Aim a pistol at the floor 
-- Aim2:		/e bron2			: Aim a pistol up to your shoulder
-- 				/e klaskanie		: Slowly clap your hands
--				/e paczka			: Pull out a box and walk around with it
--				/e klaskanie2		: Cheer
--				/e smierc2			: Lay on the ground like a bum
--				/e sciana		: Lean against a wall
--				/e lspd	: Calm down a crowd like a cop
--				/e lspd2	: Control a scene like a cop
--				/e lspd3		: idle like a cop
...
local radioButton				= 169 --- U by default  -- use 57 for f10
...
RegisterCommand("e",function(source, args)
	...
	if tostring(args[1]) == nil then
		...
		if tostring(args[1]) ~= nil then
			...
			elseif argh == 'paczka2' then
				local ad = "anim@heists@box_carry@"
				
				local prop_name = prop_name or 'prop_coolbox_01'
			...
			elseif argh == 'rower' then
				local ad = "anim@heists@box_carry@"
				
				local prop_name = prop_name or 'prop_rub_bike_02'
			...
			elseif argh == 'siedzenie' then
				...
				local prop_name = prop_name or 'prop_car_seat'
