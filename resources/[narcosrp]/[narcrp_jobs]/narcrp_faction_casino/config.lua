...
Config.kasynoStations = {
  ...
  kasyno = {
    ...
    Cloakrooms = {
      { x = -1280.0, y = -292.57, z = 45.88 },
    },

    Armories = {
      { x = 946.34, y = -954.78, z = 43.4 },
    },

    Vehicles = {
      {
        Spawner    = { x = -1287.2, y = -304.5, z = 45.88 },
        SpawnPoint = { x = -1287.2, y = -304.5, z = 45.88 },
        Heading    = 43.0,
      }
    },
    ...
    VehicleDeleters = {
      { x = -1297.15, y = -278.65, z = 38.07 },
      { x = -1287.2, y = -304.5, z = 45.88 },
    },

    BossActions = {
      { x = 944.4, y = -956.32, z = 43.38 }
    },
